...
- **Linting**: After completing all changes, run
  `golangci-lint run --fix --show-stats=false --allow-parallel-runners .` in each affected Go package
  directory and check the output for errors
